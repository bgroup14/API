        ...
        public HttpResponseMessage GetFilteredPosts(FeedFilterDTO filterDTO, int memberId)
        {
            ...
            try
            {
                ...
                var filteredPosts = db.Posts.Where(p => p.member_id != memberId).Select(x => new PostDTO()
                {
                    ...
                    distanceFromMe = (filterDTO != null)?(double)(12742 * System.Data.Entity.SqlServer.SqlFunctions.Asin(System.Data.Entity.SqlServer.SqlFunctions.SquareRoot((double)(0.5 - System.Data.Entity.SqlServer.SqlFunctions.Cos((filterDTO.meetingLocationLat - x.latitude) * 0.017453292519943295) / 2 +
          ...
          (1 - System.Data.Entity.SqlServer.SqlFunctions.Cos((filterDTO.meetingLocationLong - x.longitude) * 0.017453292519943295)) / 2    )))):-999 // 2 * R; R = 6371 km
